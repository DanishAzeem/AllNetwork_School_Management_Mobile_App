...
import com.allnetworks.allnetworks_school_management_system.databinding.FragmentSubmitStatusBinding
import com.allnetworks.allnetworks_school_management_system.models.testing.AllSubmissionModel


class SubmitStatus : Fragment(R.layout.fragment_submit_status) {

    private var adapter = SubmissionAdapter()

    lateinit var binding: FragmentSubmitStatusBinding
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        super.onViewCreated(view, savedInstanceState)
        binding = FragmentSubmitStatusBinding.bind(view)
        ...
        binding.recyclerView.apply {
            ...
            adapter = this@SubmitStatus.adapter
        }
