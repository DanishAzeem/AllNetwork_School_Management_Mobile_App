...
import com.allnetworks.allnetworks_school_management_system.databinding.FragmentPendingStatusBinding
...
class PendingStatus : Fragment(R.layout.fragment_pending_status) {
    private var adapter = SubmissionAdapter()

    lateinit var binding: FragmentPendingStatusBinding
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        super.onViewCreated(view, savedInstanceState)
        binding = FragmentPendingStatusBinding.bind(view)
        ...
        binding.recyclerView.apply {
            ...
            adapter = this@PendingStatus.adapter
        }
    }
}