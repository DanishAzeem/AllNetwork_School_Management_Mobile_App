...
import com.allnetworks.allnetworks_school_management_system.databinding.FragmentUpdateAssignmentBinding
...
@AndroidEntryPoint
class UpdateAssignment : Fragment(R.layout.fragment_update_assignment) {
    lateinit var binding: FragmentUpdateAssignmentBinding
    private var adapter = AttendanceAdapter()

    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        super.onViewCreated(view, savedInstanceState)
        binding = FragmentUpdateAssignmentBinding.bind(view)
